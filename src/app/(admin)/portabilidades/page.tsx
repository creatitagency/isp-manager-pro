export default function PortabilidadesPage() {
  return (
    <div className="space-y-5 animate-fade-in">
      <div>
        <h1 className="page-title">Portabilidades</h1>
        <p className="page-subtitle">Gestión de portabilidades móvil y fijo</p>
      </div>
      <div className="card p-12 text-center">
        <div className="text-4xl mb-4">🚀</div>
        <h2 className="text-lg font-bold text-gray-900 mb-2">Módulo Portabilidades</h2>
